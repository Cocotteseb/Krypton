...
namespace ComponentFactory.Krypton.Toolkit
{
								 ...
								 IPaletteBorder
    {
        ...
        [RefreshPropertiesAttribute(RefreshProperties.All)]
        [Editor("ComponentFactory.Krypton.Toolkit.PaletteDrawBordersEditor, ComponentFactory.Krypton.Design, Version=4.4.1.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e", typeof(UITypeEditor))]
